...
> **10 июля** аккаунт Flowseal на GitHub был временно заблокирован. Вместе с этим был заблокирован репозиторий zapret-discord-youtube. В это время **пользуйтесь [перезаливом от V3nilla](https://github.com/V3nilla/zapret-discord-youtube), а не "зеркалами" из неизвестных источников**.
